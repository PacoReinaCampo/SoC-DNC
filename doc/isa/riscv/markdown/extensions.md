...
| `rv`   | `32`      | `dnc`      | `32`              | `RV32DNC Standard Extension for Differentiable Neural Computer`              |
| `rv`   | `64`      | `dnc`      | `32`              | `RV64DNC Standard Extension for Differentiable Neural Computer (+ RV32DNC)`  |
| `rv`   | `128`     | `dnc`      | `32`              | `RV128DNC Standard Extension for Differentiable Neural Computer (+ RV64DNC)` |
: Instruction Set Extensions
